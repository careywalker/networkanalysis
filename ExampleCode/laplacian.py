"""Code provided as part of UCD MSc Advanced Software Engineering"""
# This is the original code plus my own modifications
import random
...
def plot_graph(G, pos, fignum):
    ...
    fig.suptitle("Figure Number : " + str(fignum), fontsize=14, fontweight='bold')
    fig.clf()
